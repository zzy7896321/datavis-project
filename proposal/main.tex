...
\begin{enumerate}[\textrm{Design} 1)]
    ...
    \item See Figure \ref{fig:design_2}.
        ...
        Below the map are two bar charts. The bar chart on the left shows the
        number of failed banks over the years while the right shows the top
        acquiring institions of the failed banks and the total number of
        failed banks they acquired over the years.
